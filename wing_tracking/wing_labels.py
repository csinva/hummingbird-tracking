        ...
        if bird_present:
            ...
            if frame_num - offset in labels[:, -1]:
                ...
                if slice.shape[0] > 0:
                    ...
                    cv2.circle(frame, center=(xs[0], ys[0]), color=(0, 255, 0), radius=15)
                    cv2.circle(frame, center=(xs[1], ys[1]), color=(0, 255, 0), radius=15)
                    cv2.circle(frame, center=(xs[2], ys[2]), color=(0, 255, 0), radius=15)
...
if __name__ == "__main__":
    ...
    fname_gt = oj(data_folder, 'top', 'gt', 'Pic_75.6981' + '.txt')
    offset = 6981
